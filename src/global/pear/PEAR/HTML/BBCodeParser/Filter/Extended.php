    ...
    */
    var $_definedTags = array(
                                ...
                                'code' => array('htmlopen'  => 'code',
                                                ...
                                                'allowed'   => 'all',
                                                'attributes'=> array()),
																'class' => array('htmlopen'  => 'span',
								                                 'htmlclose' => 'span',
								                                 'allowed'   => 'all',
								                                 'attributes'=> array('class' =>'class=%2$s%1$s%2$s')),
																'anchor' => array('htmlopen'  => 'a',
								                                  'htmlclose' => 'a',
								                                  'allowed'   => 'all',
								                                  'attributes'=> array('name' =>'name=%2$s%1$s%2$s',
								                                   										 'id' =>'id=%2$s%1$s%2$s')),
																'goto'   => array('htmlopen'  => 'a',
								                                  'htmlclose' => 'a',
								                                  'allowed'   => 'all',
								                                  'attributes'=> array('goto' =>'href=%2$s%1$s%2$s'))								                                  
    );
}
