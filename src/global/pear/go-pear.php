...
foreach ($installer_packages as $pkg) {
    if (isset($local_dir[$pkg])) {
        ...
        copy(dirname(__FILE__).'/go-pear-bundle/'.$local_dir[$pkg], $local_dir[$pkg]);
...
$url = "http://cvs.php.net/viewcvs.cgi/*checkout*/pear-core/PEAR.php?pathrev=$r";
...
$url = "http://cvs.php.net/viewcvs.cgi/*checkout*/pear/Archive_Tar/Archive/Tar.php?pathrev=$r";
mkdir('Archive', 0700);
...
$url = "http://cvs.php.net/viewcvs.cgi/*checkout*/pear-core/Console/Getopt.php?pathrev=$r";
mkdir('Console', 0700);
